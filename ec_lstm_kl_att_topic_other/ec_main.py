...
import sys
import os
from ec_bilstm_kl_topic_att import BiLstm
...
def main(arguments):
	...
	data = Data('../ec_lstm_kl_att_topic_other+sentiment_dasts2/data/'+args.data_name+'data_sample.bin',
				'../ec_lstm_kl_att_topic_other+sentiment_dasts2/data/'+args.data_name+'vocab_sample.bin',
				'../ec_lstm_kl_att_topic_other+sentiment_dasts2/data/'+args.data_name+'word_embed_weight_sample.bin',
				args.batch_size)
